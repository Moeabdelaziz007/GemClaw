...
/**
 * 🛰️ Sovereign URL Initializer
 * Handles ?agent= deep-linking and state-based redirection.
 * Wrapped in Suspense to satisfy Next.js CSR bailout requirements during build.
 */
function SovereignInitializer() {
