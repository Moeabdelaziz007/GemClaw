  ...
  return (
    ...
    >
      ...
      <div className="flex justify-between items-start mb-4 relative z-10">
        ...
        <div className="flex items-center gap-1 bg-zinc-800/80 px-2 py-1 rounded-md text-xs font-medium text-cyan-400 border border-cyan-900/50">
      ...
      <div className="relative z-10">
        ...
        <p className="text-zinc-400 text-sm mb-4 line-clamp-2 min-h-[40px]">
          {agent.role} • By {agent.creatorNickname || 'Sovereign Architect'}
        </p>
      ...
      <div className="mt-4 pt-4 border-t border-zinc-800/50 flex items-center justify-between text-[10px] text-zinc-500 uppercase tracking-widest relative z-10">
        <div className="flex items-center gap-1">
          <ShieldCheck className={`w-3 h-3 ${isInstalled ? 'text-zinc-600' : 'text-cyan-500'}`} />
          Neural Verified
        </div>
        <div>V1.0.4</div>
      </div>
