...
export default function AppShell({ children }: AppShellProps) {
  ...
  return (
    <div className="safe-x flex h-[100dvh] w-full overflow-hidden bg-theme-primary font-sans text-white selection:bg-gemigram-neon/30">
      <FloatingNav currentView={currentView} user={user} onLogin={login} onLogout={logout} />

      <div className="relative flex min-w-0 flex-1 flex-col">
        <header className="safe-top z-[80] shrink-0 border-b border-gemigram-neon/[0.06] glass-strong px-4 py-3 sm:px-6 md:px-8">
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div className="flex min-w-0 items-center gap-3 sm:gap-4">
              ...
              <div className="hidden items-center gap-5 lg:flex">
                ...
                <div className="group flex cursor-pointer items-center gap-2 border-l border-white/5 pl-5">
                  <Activity className="h-3.5 w-3.5 text-gemigram-neon/50 transition-colors group-hover:text-gemigram-neon" />
                  <div className="flex flex-col">
            ...
            <div className="hidden flex-1 flex-col items-center xl:flex">
              ...
              <div className="flex items-center gap-2">
                <span className="h-1.5 w-1.5 animate-pulse rounded-full bg-gemigram-neon" />
            ...
            <div className="flex items-center gap-3 sm:gap-5">
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="group relative">
                  ...
                  <div className="pointer-events-none absolute right-0 top-full mt-4 translate-y-2 opacity-0 transition-all duration-300 group-hover:pointer-events-auto group-hover:translate-y-0 group-hover:opacity-100">
                    <div className="w-64 rounded-2xl border border-white/10 bg-black/80 p-6 shadow-2xl backdrop-blur-3xl">
                      <div className="mb-6 flex items-center gap-4">
                        ...
                        <div className="flex min-w-0 flex-col overflow-hidden">
                          ...
                          <span className="truncate text-[9px] uppercase text-gemigram-neon/60">{user?.email || 'OFFLINE'}</span>
                        </div>
                      </div>
        ...
        <footer className="pointer-events-none absolute bottom-6 left-1/2 z-50 hidden -translate-x-1/2 xl:flex">
          <div className="pointer-events-auto flex items-center gap-5 rounded-full border border-gemigram-neon/[0.08] glass-strong px-6 py-2.5">
            ...
            <div className="flex items-center gap-2 border-l border-white/10 pl-5">
              <Activity className="h-3 w-3 animate-pulse text-gemigram-neon" />
